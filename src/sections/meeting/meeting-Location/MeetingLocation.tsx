...
export default function MeetingLocation() {
  return (
    <div
      ...
      className="flex justify-between items-center w-full min-h-screen px-6 overflow-hidden"
    >
      {/* Left: Image */}
      <div className="relative w-1/2 h-[70%]">
        ...
        {/* FIXED: no more going outside */}
        <img
          src={LakeViewImage}
          alt="Lake View"
          className="absolute top-1/2 -translate-y-1/2 right-0 translate-x-1/4 h-[60%] object-cover rounded-lg shadow-lg"
        />
      </div>

      {/* Right: Text */}
      <div className="w-[40%] text-[#1f3a37] text-center px-6 bg-white/70 backdrop-blur-md rounded-lg shadow-lg p-6">
        <h2 className="text-3xl font-bold mb-4">Location</h2>
        <h3 className="text-xl font-semibold mb-4">
          A Setting That Inspires Wonder
        </h3>
        <p className="text-lg leading-relaxed text-[#1f3a37]/80">
