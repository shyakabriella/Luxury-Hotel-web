...
export default function GetInspired() {
  const images = [
    "/src/assets/images/meetings/food-plate.png",
    "/src/assets/images/meetings/menu.png",
    "/src/assets/images/meetings/meeting-speech.png",
    "/src/assets/images/meetings/hotel-from-outside.png",
    "/src/assets/images/meetings/hotel-checklist.png",
    "/src/assets/images/meetings/horse-carrier.png",
  ];
